...
public class MoneyTextView extends View {
    ...
    private static final int GRAVITY_CENTER_VERTICAL   = 0;
    private static final int GRAVITY_CENTER_HORIZONTAL = 0;
    ...
    private void drawSection(Canvas canvas, MoneyTextView.Section section) {
    ...
    public void setAmount(double amount, String symbol) {
        mAmount = amount;
