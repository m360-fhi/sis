...
public class SttudentAttendanceAdapter extends ArrayAdapter<HashMap<String, String>> {
    ...
    public SttudentAttendanceAdapter(@NonNull Context context, @NonNull List<HashMap<String, String>> objects) {
